...
public class Hunt extends Enemy implements Checkable{
    ...
    public Hunt(String name, String locationMain, String locationZone, int level, String stealItems, String wiki, String huntName, int rank, String petitioner, String petitionerLocationMain, String petitionerLocationZone) {
