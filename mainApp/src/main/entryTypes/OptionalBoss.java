...
public class OptionalBoss extends Enemy{
    ...
    public OptionalBoss(String name, int entryNum, String locationMain, String locationZone, int level, String stealItems, String wiki, String reward, String quest) {
